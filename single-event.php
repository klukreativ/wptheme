<!-- any time we register a custom post type, WP will automatically search for 'single-posttype' as a template -->
...
while (have_posts()) {
    ...
    <div class="container container--narrow page-section">
        ...
        <?php
        // checks ACF for any related programs, then outputs section incl link to program if there is
