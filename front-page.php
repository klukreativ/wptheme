...
<div class="full-width-split group">
    <div class="full-width-split__one">
        <div class="full-width-split__inner">
            ...
            <?php // displays upcoming events by filtering out past events and displaying the 2 closest using custom queries
            $today = date('Ymd');
    ...
    <div class="full-width-split__two">
        <div class="full-width-split__inner">
            ...
            <?php
            $homepagePosts = new WP_Query(array( // creates new instance from object
                'posts_per_page' => 2,
            ));
            ...
            <?php }
            wp_reset_postdata(); // cleans up data prior to custom query
            ?>
